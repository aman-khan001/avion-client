  ...
  return (
    <>
      ...
      <section className="section">
        <div className="container flex flex-col gap-8 xl:flex-row xl:items-start xl:gap-10">
          <div className="w-full xl:w-[50%] space-y-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <GlassCard className="flex items-center gap-4 p-5 sm:col-span-2">
            ...
            <GlassCard className="overflow-hidden p-0">
              <iframe
                ...
                loading="lazy"
                className="block h-full w-full object-cover filter grayscale contrast(1.3) opacity-80"
              />
            </GlassCard>
          </div>
