...
export default function Courses() {
  return (
    <>
    <SEO
      title="Courses | Avion Training & Placement Centre"
      description="Explore our comprehensive courses designed to build your skills and advance your career. Choose from tracks in Web Development, AI/ML, and more, each with hands-on projects and placement support."
    />
