            ...
            >
              ...
              <div className="md:col-span-2">
                ...
                <p className="mt-2 text-xs text-white/45">
                  Uploads are stored in Cloudinary when credentials are
                  configured; otherwise metadata is retained for local
                  development.
                </p>
              </div>
              <div className="md:col-span-2">
              ...
              {error && (
                <p className="md:col-span-2 rounded-lg border border-red-400/30 bg-red-500/10 p-3 text-sm text-red-200">
                  {error}
                </p>
              )}
              <button
                className="btn btn-primary justify-center md:col-span-2"
